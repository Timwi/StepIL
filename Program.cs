...
namespace StepIL
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var ilFile = File.Open(ilPath, FileMode.Create, FileAccess.Write))
                    ...
                    foreach (var method in type.Methods)
                    {
                        ...
                        if (method.Body != null)
                        {
                            ...
                            foreach (var instruction in method.Body.Instructions)
                            {
                                ...
                                {
                                    StartLine = curLine, StartColumn = 9,
                                    EndLine = curLine, EndColumn = instruction.ToString().Length + 9
                                };
                            }
